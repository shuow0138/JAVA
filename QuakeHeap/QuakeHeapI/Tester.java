...
/**
 * Testing program for Part 0. By default, this reads from tests/test05-input.txt and
 * writes the output to tests/test05-output.txt. Change inputFileName and outputFileName
